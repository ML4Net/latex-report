        ...
        \subsubsection{Random Forest}
            ...
            \begin{itemize}
                ...
                \item \textit{Hyperparameter Analysis}
                    ...
                    The model showed particularly strong performance in Discovery classification, with only 19 total misclassifications (10 false positives and 9 false negatives) out of 69,911 cases, demonstrating exceptional precision in identifying this attack type.

                    % 3
                    
                    The hyperparameter tuning process revealed several crucial insights about the model's behavior. The optimized model showed improved handling of edge cases while maintaining strong performance on mainstream attack patterns. As evidenced in the confusion matrices, the false positive rates decreased significantly for critical attack categories like Defense Evasion and Execution, suggesting that the tuned model became more discriminative in its classifications.
            
                    A particularly noteworthy observation is how the model balances precision and recall across different attack categories. The tuning process helped achieve a better equilibrium, especially for categories with smaller representation in the dataset. This improvement indicates that careful parameter selection can help mitigate the inherent challenges of imbalanced security data.
                ...
                \item \textit{Comparative Analysis of Baseline and Optimized Models}
                    ...
                    Comparing train and test performance reveals consistent behavior with minimal overfitting:
