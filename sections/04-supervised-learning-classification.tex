...
\section{SUPERVISED LEARNING - CLASSIFICATION}
    ...
    \subsection{Hyperparameter Tuning}
        ...
        \subsubsection*{1. Random Forest \\}
            ...
            The grid search explored combinations of the number of estimators (10, 50, and 100) and maximum depth (unlimited, 10, 50, and 100). The best-performing configuration was selected based on weighted F1-scores.
